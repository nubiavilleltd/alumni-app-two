 ...
 */
$config['site_title']                 = "FGGC Alumni Portal";       // Site Title, example.com
//$config['admin_email']                = "appnotice@nubiaville.com"; // Admin Email, admin@example.com
$config['admin_email']                = "nubiavilleprojects@gmail.com"; // Admin Email, admin@example.com
...
$config['forgot_password'] = TRUE;
                 // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
